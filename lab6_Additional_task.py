...
def func(x1, x2, x3):
    coeffs = [9.1, 3.9, 5.3, 4.6, 4.8, 0.7, 3.6, 7.0, 1.0, 5.7, 2.5]
...
while l < 50:
    ...
    importance, len_k_i = student_criteria(m, N, y_arr, coefficients)
    l += len_k_i
    print("\nДодаткове завдання\nПоточна кількість значимих коефіцієнтів = " + str(l))
    d = len(list(filter(None, importance)))
    fisher_criteria(m, N, d, natural_plan, y_arr, coefficients, importance)
    k += 1
print("\nДодаткове завдання\nКількість ітерацій для знаходження потрібної кількості значимих коефіцієнтів = " + str(k))
